<%
 ...
 Subject = HexToASCII(Request.Form("SUBJECT"))
 Detail = HexToASCII(Request.Form("Detail"))
 ContactUID = CLng(CID)
 Tab = Chr(9)
'==============================================================
...
'==============================================================
 ...
 cmdTemp.CommandText = "Select * From Notes Where NoteUID=0"
 cmdTemp.CommandType = 1
 Set cmdTemp.ActiveConnection = DataConn
 rstContacts.Open cmdTemp, , 1, 3
 rstContacts.AddNew
 rstContacts("ContactUID") = ContactUID
 rstContacts("Created") = DAYT
 rstContacts("Subject") = Subject
 rstContacts("Detail") = Detail
 rstContacts.Update
 rstContacts.Close
 DataConn.Close
 Result = Tab & "{EOF}"
